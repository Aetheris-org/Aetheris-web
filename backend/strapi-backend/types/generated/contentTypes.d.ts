...
export interface ApiArticleReactionArticleReaction extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User reactions to articles (like/dislike)';
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User-created articles with rich text content';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::article.article'> &
      Schema.Attribute.Private;
    preview_image: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCommentReactionCommentReaction extends Struct.CollectionTypeSchema {
  collectionName: 'comment_reactions';
  info: {
    description: 'User reactions to comments (like/dislike)';
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Comments on articles with nested replies support';
    displayName: 'Comment';
    pluralName: 'comments';
...
export interface PluginUsersPermissionsUser extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Platform users managed by Users & Permissions plugin';
    displayName: 'User';
    pluralName: 'users';
    singularName: 'user';
  };
