...
export const mockActivityFeed: MockActivityItem[] = [
  {
    id: 'activity-1',
    type: 'article',
    title: 'Опубликована статья "Глубокое погружение в Strapi v5"',
  ...
  },
  {
    id: 'activity-2',
    type: 'comment',
    title: 'Оставлен комментарий к статье "React и TypeScript"',
  ...
  },
  {
    id: 'activity-3',
    type: 'reaction',
    title: 'Получено 25 лайков на статью "Vue vs React"',
  ...
  },
  {
    id: 'activity-4',
    type: 'bookmark',
    title: 'Добавлено в закладки: "Design Systems Best Practices"',
  ...
  },
  {
    id: 'activity-5',
    type: 'article',
    title: 'Опубликована статья "Создание адаптивного UI с Shadcn/ui"',
...
export const mockCreatorGoals: MockCreatorGoal[] = [
  {
    id: 'goal-1',
    title: 'Опубликовать 50 статей',
    description: 'Текущий прогресс: 34 из 50',
    progress: 34,
    target: 50,
    completed: false,
  },
  {
    id: 'goal-2',
    title: 'Набрать 1000 подписчиков',
    description: 'Текущий прогресс: 756 из 1000',
    progress: 756,
    target: 1000,
    completed: false,
  },
  {
    id: 'goal-3',
    title: 'Достичь уровня 20',
    description: 'Текущий прогресс: уровень 15',
    progress: 15,
    target: 20,
    completed: false,
  },
